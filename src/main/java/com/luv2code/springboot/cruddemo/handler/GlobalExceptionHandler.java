...
public ResponseEntity<ErrorResponse> handleNotFoundException(CustomerNotFoundException ex) {
    ...
    public  ResponseEntity<ErrorResponse>  handleStartBeforeScheduledTimeException(StartBeforeScheduledTimeException ex){
        ErrorResponse errorResponse = new ErrorResponse(
                HttpStatus.BAD_REQUEST.value(),
                ex.getMessage(),
                LocalDateTime.now()
    ...
    public  ResponseEntity<ErrorResponse>  handleDriverBookedMoreThan3TripsException(DriverBookedMoreThan3TripsException ex){
        ErrorResponse errorResponse = new ErrorResponse(
                HttpStatus.BAD_REQUEST.value(),
                ex.getMessage(),
                LocalDateTime.now()
    ...
    public  ResponseEntity<ErrorResponse>  handlePaymentMethodIsNotSupportedException(PaymentMethodIsNotSupportedException ex){
        ErrorResponse errorResponse = new ErrorResponse(
                HttpStatus.BAD_REQUEST.value(),
                ex.getMessage(),
                LocalDateTime.now()
